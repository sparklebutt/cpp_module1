...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/05 15:12:33 by shaboom           #+#    #+#             */
/*   Updated: 2024/12/05 15:53:22 by shaboom          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * if keyword matches user input iterator is used in switch case to match call.
 * fallthrough allows us to bypass the break statement, baisiaclly ignoring compiler error.
 * May not be needed on all machines !
		...
		if (level == keywords[i])
		{
			switch (i)
			{
				...
				case 3:
					...
					[[fallthrough]];
				default:
					std::cout<<"some strange blabla"<<std::endl;
				return ;
			}
		}
	}
